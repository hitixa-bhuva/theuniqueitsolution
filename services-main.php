...
<div class="wrapper">
    <main>
        <!-- 1. hero Who We Are -->
        <section class="banner overlyshadow page-banner mb-9" id="hero-section" style="background-image: url(./assest/img/hero/services-banner.webp);">
            <div class="MuiContainer-root MuiContainer-maxWidthXl css-k4xlog">
                <div class="banner-content">
                    <h2 class="MuiTypography-root MuiTypography-h2 pb-3 css-17zkhbb" id="hero-title">Our Services</h2>
                    <p class="MuiTypography-root MuiTypography-body1 css-1b7jm6v" id="hero-text">Top-tier Web Development, Custom Software Solutions, and Mobile App Development using cutting-edge technologies for exceptional results.</p>
                </div>
            </div>
        </section>
        <div class="MuiContainer-root MuiContainer-maxWidthXl mb-9 css-k4xlog">
            <div class="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-3 MuiGrid-spacing-sm-4 MuiGrid-spacing-xl-6 css-16rxbyr services-main-card">
                <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-6 MuiGrid-grid-md-4 css-18xehxy aos-init pt-0" data-aos="fade-up">
                        ...
                        <div class="MuiCardActions-root MuiCardActions-spacing css-ny0n9o">
                            <a href="services/custom-software-development">
                                <button
                                    ...
                                    title="Discover More"
                                >
                                    Discover More<span class="MuiButton-icon MuiButton-endIcon MuiButton-iconSizeMedium css-lkx0br"><img loading="lazy" src="./assest/img/svg/ic-right-arrow-primary..svg" alt="Right Arrow" /></span>
                ...
                <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-6 MuiGrid-grid-md-4 css-18xehxy aos-init pt-0" data-aos="fade-up">
                    <div class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 MuiCard-root service-card css-167ndxh">
                        <div class="MuiCardContent-root css-1qw96cp">
                            ...
                            <p class="MuiTypography-root MuiTypography-body2 css-1i5tpjv">
                                Simplify your business operations with our advanced workflow automation solutions. Eliminate time-consuming manual tasks and boost productivity, freeing your team to focus on strategic, high-impact
                                activities.
                            </p>
                        </div>
                        <div class="MuiCardActions-root MuiCardActions-spacing css-ny0n9o">
                ...
                <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-6 MuiGrid-grid-md-4 css-18xehxy aos-init" data-aos="fade-up">
                    <div class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 MuiCard-root service-card css-167ndxh">
                        <div class="MuiCardContent-root css-1qw96cp">
                            ...
                            <p class="MuiTypography-root MuiTypography-body2 css-1i5tpjv">
                                Professional website development ensures a strong online presence. We design responsive, SEO-optimized websites tailored to your business objectives, whether for e-commerce or corporate purposes, enhancing
                ...
                <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-6 MuiGrid-grid-md-4 css-18xehxy aos-init" data-aos="fade-up">
                    <div class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 MuiCard-root service-card css-167ndxh">
                        <div class="MuiCardContent-root css-1qw96cp">
                            ...
                            <p class="MuiTypography-root MuiTypography-body2 css-1i5tpjv">
                                We offer full-stack mobile app development for Android and iOS, delivering user-friendly, feature-rich apps. Whether it's for business or e-commerce, our specialized team ensures engaging user experiences
                                across platforms.
                            </p>
                        </div>
                        <div class="MuiCardActions-root MuiCardActions-spacing css-ny0n9o">
                ...
                <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-6 MuiGrid-grid-md-4 css-18xehxy aos-init" data-aos="fade-up">
                    <div class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 MuiCard-root service-card css-167ndxh">
                        <div class="MuiCardContent-root css-1qw96cp">
                            ...
                            <p class="MuiTypography-root MuiTypography-body2 css-1i5tpjv">
                                Our unique UI/UX designs delight thousands of customers, enhancing user experience and engagement. These visually appealing interfaces ensure smooth user journeys with both beauty and functionality.
                            </p>
                        </div>
                        <div class="MuiCardActions-root MuiCardActions-spacing css-ny0n9o">
                ...
                <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-6 MuiGrid-grid-md-4 css-18xehxy aos-init" data-aos="fade-up">
                    <div class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 MuiCard-root service-card css-167ndxh">
                        <div class="MuiCardContent-root css-1qw96cp">
                            ...
                            <p class="MuiTypography-root MuiTypography-body2 css-1i5tpjv">
                                Utilize our IT consultancy services to align your infrastructure with business goals, secure against breaches, and integrate cutting-edge technologies swiftly. Our consultants work closely with you to
                                diagnose and resolve issues, ensuring rapid success.
                            </p>
                        </div>
                        <div class="MuiCardActions-root MuiCardActions-spacing css-ny0n9o">
                            ...
                            <div class="accordion" id="faqAccordion">
                                <div class="accordion-item">
                                    ...
                                    <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body css-bqexvl">
                                            Selecting the right custom software development company seems like a complicated process but it's unique straightforward. To choose the right outsourcing partner fro your project, you must
                                            understand theie development process, past experiance of successfully executing similar software projects and expertise in teh technology stack.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body css-bqexvl">
                                            Software development is the process of creating, designing, testing, and maintaining software programs and applications.Custom software can be scaled and adapted as your business grows, ensuring
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body css-bqexvl">
                                            The software development life cycle divided into 5 major stages.This start from requirement gathering,Software designing,Coding,Testing,Deployment.And Following all above state cerate the relaible
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body css-bqexvl">
                                            We use a variety of technologies depending on your project needs. This includes programming languages like Java, Python, and JavaScript, along with web technologies such as HTML, CSS, and
                                            frameworks like React or Angular. For back-end development, we use tools like Node.js, .NET, or PHP, and databases such as MySQL or MongoDB. Cloud platforms like AWS or Azure are also used to
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body css-bqexvl">
                                            We provide comprehensive maintenance for our services, which includes regular updates, bug fixes, and performance improvements. Our maintenance ensures that your software continues to operate
                                            smoothly and remains up-to-date with the latest technologies and security standards.
                                        </div>
                                    </div>
                                </div>
                            </div>
